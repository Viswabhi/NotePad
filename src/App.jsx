    ...
    <div style={{ display: "flex", height: "100vh" }}>
      {notes.length === 0 ? (
        <div style={{ display: "flex", flex: 1, justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
          ...
          <button onClick={addNote} style={{ backgroundColor: "#62A5EB", color: "white", padding: "10px 15px", border: "none", cursor: "pointer" }}>
            Create Note
          </button>
        </div>
      ) : (
        <>
          <div style={{ width: "25%", borderRight: "1px solid #ddd", padding: "10px", overflowY: "auto" }}>
            <button onClick={addNote} style={{ width: "100%", backgroundColor: "#62A5EB", color: "white", padding: "10px", border: "1px solid grey", cursor: "pointer", marginBottom: "10px" }}>
              Create Note
            </button>
